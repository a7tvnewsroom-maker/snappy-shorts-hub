...
const Header = ({ activeTab, onTabChange, onMenuClick, onCreateClick }: HeaderProps) => {
  const tabs = [
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-card border-b border-border safe-area-top lg:hidden">
      {/* Mobile Logo bar */}
